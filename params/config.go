...
func (c *ChainConfig) Description() string {
	...
	banner += fmt.Sprintf(" - Cancun Timestamp:              @%-10v (https://github.com/cryft-labs/cryftgoases/tag/v1.12.0)\n", ptrToString(c.CancunTime))

	banner += "Avalanche Upgrades (timestamp based):\n"
	banner += fmt.Sprintf(" - SubnetEVM Timestamp:           @%-10v (https://github.com/cryft-labs/cryftgoases/tag/v1.10.0)\n", ptrToString(c.SubnetEVMTimestamp))
	banner += fmt.Sprintf(" - Durango Timestamp:            @%-10v (https://github.com/cryft-labs/cryftgoases/tag/v1.11.0)\n", ptrToString(c.DurangoTimestamp))
	banner += "\n"
